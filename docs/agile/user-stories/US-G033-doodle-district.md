...
- **Acceptance Criteria:**
  - [x] จัดทำเอกสาร GDD ใน `docs/gdd/games/doodle-district/spec.md`
  - [x] ออกแบบ Shader / Material สไตล์กระดาษกราฟและลายเส้นดินสอ/หมึกปากกา (Notebook Doodle Shaders)
  - [x] ถอดโครงสร้าง City Map: อาคารลายเส้น, ทางเดินแคบ, จุดซุ่มยิง, และแท่นเกิด (Spawn Points)
  - [x] กำหนด Message Payload ของ PeerJS: Player Movement (Pos/Rot), Bullet Spawn, Damage Event, Score Sync
...
- **Acceptance Criteria:**
  - [x] ดาวน์โหลดไฟล์ทั้งหมดจาก `https://doodleshooter.vercel.app/`
  - [x] แปลง Import Map ชี้ Three.js และ PeerJS มาเป็น Local Vendor Files ในโฟลเดอร์เกมเพื่อ Zero-CDN reliance
  - [x] โหลด Google Webfonts แบบ Local Storage หรือ Fallback ป้องกันเว็บออฟไลน์โหลดฟอนต์ไม่ขึ้น
  - [x] สกัด Texture ลายกระดาษสมุด (Notebook Grid Texture) และโมเดล Doodle Props
...
- **Acceptance Criteria:**
  - [x] การควบคุมมุมกล้อง 3D ลื่นไหล 60 FPS พร้อมฟังก์ชัน Pointer Lock เมื่อคลิกที่หน้าจอ
  - [x] การเคลื่อนที่: WASD เดินหน้า-ถอยหลัง-สไลด์ข้าง, Spacebar กระโดด, Shift วิ่งเร็ว
  - [x] ระบบอาวุธ: ปืนลายเส้นยิงกระสุนหมึก/ดินสอ มีวิถีวิถีโค้งเล็กน้อยและ Particle ลายเส้นเวลาชนผนัง
  - [x] ระบบ Singleplayer Sandbox / Target Range สำหรับทดสอบยิงเป้ากระดาษเคลื่อนที่
...
- **Acceptance Criteria:**
  - [x] ระบบสร้างห้อง PeerJS และคัดลอกรหัสห้อง (Share Room Code / Direct URL Hash) ให้เพื่อนเข้าร่วมได้ทันที
  - [x] HUD Overlay (`<div id="hud">`): เป้าเล็ง Crosshair ลายเส้นมือวาด, แถบพลังชีวิต, ตัวบอกกระสุน และ Killfeed
  - [x] ระบบจัดการกรณีหลุดการเชื่อมต่อ (Peer Disconnection Graceful Handling)
  - [x] ลงทะเบียนการ์ดเกมใน `src/app/page.js` ภายใต้หมวดหมู่ "Three.js 3D Engine"
