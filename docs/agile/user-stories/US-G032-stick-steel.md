...
- **Acceptance Criteria:**
  - [x] จัดทำเอกสาร GDD ใน `docs/gdd/games/stick-steel/spec.md`
  - [x] วิเคราะห์คลังอาวุธ: ดาบสั้น (Shortsword), กระบองมีหนาม (Mace), ดาบยาวสองมือ (Two-handed Longsword)
  - [x] ออกแบบระบบปัดป้องดาบ (Blade Clashing & Parry Stun) และการหลุดมือของอาวุธ (Disarm Physics)
  - [x] กำหนด State Machine ของนักรบ: Idle, Windup, Swing, Recoil, Knockdown, Ragdoll Recovery
...
- **Acceptance Criteria:**
  - [x] ดาวน์โหลดไฟล์หลักจาก `https://stick-steel.genex.technology/` พร้อมอ้างอิง source จาก `Rabneba/stick-steel`
  - [x] สกัดฟอนต์ `./fonts/PatrickHand-Regular.ttf` และตั้งค่า `@font-face` ให้โหลดแบบ Local ออฟไลน์ได้
  - [x] ตัดต่อและถอดรหัสเสียงปะทะใบดาบ (Sword Clash), เสียงตกหลุมหนาม (Splinter Impalement), เสียงลมเหวี่ยง
  - [x] จัดระบบไฟล์ให้รันผ่าน `index.html` แบบ Standalone ภายใน `public/games/stick-steel/`
...
- **Acceptance Criteria:**
  - [x] สะพานไม้แคบพร้อมขอบเขต Collider และโซนกับดักหนามด้านล่างที่ทำให้ตายทันที
  - [x] การควบคุมนักรบ: เคลื่อนที่ซ้าย-ขวา (A/D หรือ Arrows), กระโดด (W/Space), เหวี่ยงดาบตามองศาเมาส์/ทัช
  - [x] ปฏิกิริยาการปะทะ: ดาบชนดาบเกิดสะเก็ดไฟและแรงดีดกลับ, ดาบชนตัวสร้างดาเมจและแรงผลัก
  - [x] Bot AI: มี 3 ระดับฝีมือ (Novice, Swordsman, Master) สามารถอ่านระยะดาบและบล็อกการโจมตีได้
...
- **Acceptance Criteria:**
  - [x] เมนูเลือกโหมด: ซ้อมกับหุ่นฟาง (Practice Dummy), ดวลเดี่ยวกับ AI, และดวล 2 คนบนคีย์บอร์ดเดียวกัน
  - [x] UI โทนกระดาษสเก็ตช์หมึกดำ-กระดาษคราฟต์ (`#efeeeb`) แสดงชื่อนักดาบ, อาวุธที่เลือก และสถิติยก
  - [x] รองรับ Mobile Gesture Controls (Virtual Joystick สำหรับขยับตัว + Dial สำหรับบังคับทิศทางดาบ)
  - [x] บันทึกการ์ดลง `src/app/page.js` ในหมวดหมู่ "เกมต่อสู้ / ฟิสิกส์" และทดสอบเล่นบน Modal Iframe
