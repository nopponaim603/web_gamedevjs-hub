...
- **Acceptance Criteria:**
  - [ ] จัดทำเอกสาร GDD ใน `docs/gdd/games/dead-end/spec.md`
  - [ ] วิเคราะห์ Core Loop: Defense Waves → Scavenge Supply Drops → Field Upgrade Choice → Evacuation
  - [ ] ถอดสูตรคำนวณ Damage, Ammo Capacity, Reload Rate, Stamina Regen และ Spitter Acid Trajectory
  - [ ] ออกแบบ Data Schema สำหรับ Roguelike Field Perks (เช่น Hollow Point, Sprint Booster, Fast Hands)
...
- **Acceptance Criteria:**
  - [ ] สแครป HTML, CSS, Module JS จาก `https://dead-end.replit.app/`
  - [ ] สกัดและดาวน์โหลด Brand Assets (`./brand/dead-end-logo.svg`, `./favicon.svg`, icons)
  - [ ] ถอดรหัส Audio Synthesizer / Sound FX (ปืน M4, ลูกซอง, เสียงคำรามซอมบี้, เสียงหวอไซเรน)
  - [ ] ปลดล็อกข้อจำกัด Replit analytics script ให้ทำงานแบบ Self-contained Standalone
...
- **Acceptance Criteria:**
  - [ ] ควบคุมตัวละคร WASD + Mouse Aim 360° พร้อมระบบ Sprint (Shift) และ Dodge Roll (Space)
  - [ ] ระบบสลับอาวุธ M4 Carbine (Full Auto) และ Shotgun (Spread), รีโหลดกระสุน (R)
  - [ ] AI ซอมบี้ 3 ประเภท: Walker ธรรมดา, Spitter พ่นกรดระยะไกล, และ Sector Threat Boss พร้อม Health Bar
  - [ ] ระบบ Field Upgrade Modal: สุ่มเลือก Perk 1 ใน 3 หลังจบเวฟ (กดคีย์ 1, 2, 3 หรือคลิก)
...
- **Acceptance Criteria:**
  - [ ] Canvas Minimap แสดงตำแหน่งผู้เล่น, ซอมบี้ (Hostiles) และกล่องกระสุน (Supply Drops) แบบ Realtime
  - [ ] HUD Elements: หลอดเลือด Health Bar, Stamina Track, ตัวนับ Kill Combo Streak, Boss Threat Bar
  - [ ] Virtual Joysticks และปุ่มสัมผัสบนหน้าจอมือถือ (Move-pad, Aim-pad, Reload, Dodge, Swap)
  - [ ] ลงทะเบียนการ์ดเกมใน `src/app/page.js` และทดสอบการเปิดเล่นผ่าน Iframe Modal ที่ 60 FPS
